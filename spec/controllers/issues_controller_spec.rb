...
describe IssuesController do
  ...
  describe "unpublished" do
    let(:unpublished_issue) { FactoryBot.create(:unpublished_issue, published: false) }

    describe "#show" do
      it "is not authorized" do
        expect{get :show, id: unpublished_issue.friendly_id}.to raise_error CanCan::AccessDenied
      end
    end
  end
end
