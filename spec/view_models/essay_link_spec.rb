...
describe EssayLink do
  ...
  describe '#link_to_image' do
    it "renders the correct text" do
      expect(subject.link_to_image).to eq("<a class=\"image-link\" href=\"/volumes/ifid/essays/fid\"><img src=\"/images/thumbnail\" alt=\"Thumbnail\" /></a> <a class=\"title\" href=\"/volumes/ifid/essays/fid\">title</a>")
    end
  end
