...
ActiveRecord::Schema.define(version: 20210803150453) do
  ...
  create_table "awards", force: :cascade do |t|
    ...
    t.integer  "cover_image_file_size",    limit: 8
  ...
  create_table "essays", force: :cascade do |t|
    ...
    t.integer  "author_image_file_size",       limit: 8
    ...
    t.integer  "thumbnail_image_file_size",    limit: 8
  ...
  create_table "issues", force: :cascade do |t|
    ...
    t.integer  "old_cover_image_file_size",      limit: 8
    ...
    t.integer  "large_cover_image_file_size",    limit: 8
    ...
    t.integer  "small_cover_image_file_size",    limit: 8
  ...
  add_index "redactor2_assets", ["assetable_type", "assetable_id"], name: "idx_redactor_assetable", using: :btree
  add_index "redactor2_assets", ["assetable_type", "type", "assetable_id"], name: "idx_redactor_assetable_type", using: :btree
